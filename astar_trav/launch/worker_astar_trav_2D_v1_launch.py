...
def generate_launch_description():
    ...
    launch_description.append(
        launch_ros.actions.Node(
            ...
            package="astar_trav", 
            executable="astar_trav_2D_all_in_one", # Defined in the setup.py entrypoints
            name=["astar_trav_2D_all_in_one", LaunchConfiguration("wid")], # This will change the node's name
            output="screen",
            parameters=[
